import { Holding, CapitalGains } from '../types/index'

// ── Exact Capital Gains from assignment doc ───────────────────────────
const mockCapitalGainsData: CapitalGains = {
  capitalGains: {
...
// ── Exact Holdings from assignment doc (25 items) ─────────────────────
const mockHoldingsData: Holding[] = [
  {
    coin: 'USDC',
    coinName: 'USDC',
...
export const fetchHoldings = (): Promise<Holding[]> =>
  new Promise(resolve => setTimeout(() => resolve(mockHoldingsData), 800))

export const fetchCapitalGains = (): Promise<CapitalGains> =>
  new Promise(resolve => setTimeout(() => resolve(mockCapitalGainsData), 800))
